...
helm.sh/chart: {{ include "new-namespace.chart" . }}
{{ include "new-namespace.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "new-namespace.selectorLabels" -}}
app.kubernetes.io/name: {{ include "new-namespace.name" . }}
